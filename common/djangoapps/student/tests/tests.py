...
class EnrollInCourseTest(TestCase):
    ...
    def test_enroll_in_course(self):
        self.ext_user = User.objects.create_user("joe", "joe@joe.com", "password")
        self.ext_user.save()
        self.assertFalse(is_enrolled_in_course(self.ext_user, "course_id"))
        enroll_in_course(self.ext_user, "course_id")
        self.assertTrue(is_enrolled_in_course(self.ext_user, "course_id"))
